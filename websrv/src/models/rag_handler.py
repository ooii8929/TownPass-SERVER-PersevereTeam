...
def rag_handler(audience, language, location, character,stage, all_locations,visited_locations, userInput= ""):
    ...
    print("location",base_dir,persist_directory)
    ...
    chain = (
        {
            ...
            "all_locations": lambda x: x["all_locations"],
            "visited_locations": lambda x: x["visited_locations"]
        }
        | prompt
        | model
        | JsonOutputParser()
